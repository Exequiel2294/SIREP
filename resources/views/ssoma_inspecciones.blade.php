    ...
    <script>
        ...
        $(document).ready(function(){     
            $("#data-table").DataTable({
                ...
                columns: [
                    ...
                    {data:'area_contratista_inspeccionada', name:'area_contratista_inspeccionada'},
                    {data:'lugar_frente', name:'lugar_frente'},
                    {data:'hallazgos', name:'hallazgos'},
                    {data:'nivel_criticidad', name:'nivel_criticidad'},
                    {data:'planes_accion', name:'planes_accion'},
                    {data:'solucion_momento', name:'solucion_momento'},
                    {data:'responsable_plan_accion', name:'responsable_plan_accion'},
        ...
        $(document).on('click', '.edit', function(){ 
            ...
            $.get('inspeccion/'+id+'/edit', function(data){
                ...
                $('#area_contratista').val(data.area_contratista_inspeccionada),
                $('#lugar').val(data.lugar_frente),
                $('#hallazgos').val(data.hallazgos),
                $('#nivel').val(data.nivel_criticidad),
                $('#accion').val(data.planes_accion),
                $('#solucion').val(data.solucion_momento),
                $('#responsable').val(data.responsable_plan_accion),
            ...
            if($("#modal-form").valid()){
                ...
                $.ajax({
                    ...
                    data:{
                        ...
                        area_contratista_inspeccionada:$('#area_contratista').val(),
                        lugar_frente:$('#lugar').val(),
                        hallazgos:$('#hallazgos').val(),
                        nivel_criticidad:$('#nivel').val(),
                        planes_accion:$('#accion').val(),
                        solucion_momento:$('#solucion').val(),
                        responsable_plan_accion:$('#responsable').val(),
                    ...
                    <table style="width:100%" class="table table-striped table-bordered table-hover datatable" id="data-table">
                        <thead>
                            <tr>
                                ...
                                <th>Area Contratista Inspeccionada</th>
                                <th>Lugar/Frente</th>
                                <th>Hallazgos</th>
                                <th>Nivel de Criticidad</th>
                                <th>Planes de Accion</th>
                                <th>¿Se pudo solucionar en el momento?</th>
                                <th>Responsable de ejecutar el plan de accion</th>
                ...
                <div class="modal-bod">
                    ...
                    <form action="post" id="modal-form" name="modal-form" autocomplete="off">
                        ...
                        {{--Area reportante--}}
                         ...
                         {{--Area contratista inspeccionada--}}
                         <div class="form-group">
                            <label for="area_contratista" class=" col-form-label">Area contratista inspeccionada:</label>
                            <div class="col-sm">
                              <input type="text" class="form-control" id="area_contratista" name="area_contratista" placeholder="Area contratista inspeccionada">
                            </div>
                        </div>
                        {{--Area contratista inspeccionada--}}
                        ...
                        {{-- TAREA HALLAZGO --}}
                        <div class="form-group">
                            <label for="hallazgos" class="col-form-label">Hallazgos:</label>
                            <div class="col-sm">
                              <input type="text" class="form-control" id="hallazgos" name="hallazgos" placeholder="Hallazgos">
                            </div>
                        </div>
                        {{-- TAREA HALLAZGO --}}
                        ...
                        {{-- PLANES DE ACCION --}}     
                        <div class="form-group ">
                            <label for="accion" class="col-form-label">Planes de accion:</label>
                            <div class="col-sm">
                                <select class="form-control company" name="accion" id="accion">
                        ...
                        {{-- SE PUDO SOLUCIONAR EN EL MOMENTO --}}     
                        <div class="form-group ">
                        ...
                        {{-- RESPONSABLE DE EJECUTAR EL PLAN DE ACCION  --}}
                        <div class="form-group">
                            <label for="responsable" class="col-form-label">Responsable de ejecutar el plan de accion:</label>
                            <div class="col-sm">
                              <input type="text" class="form-control" id="responsable" name="responsable" placeholder="Responsable de ejecutar el plan de accion">
                            </div>
                        </div>
                        {{-- RESPONSABLE DE EJECUTAR EL PLAN DE ACCION --}}
