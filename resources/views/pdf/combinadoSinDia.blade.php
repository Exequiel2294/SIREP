...
<html>
    ...
    <body>
        <header>
            ...
            {{-- <p class="left" style="font-size: 23px;">Daily Report: 2022-09-02 </p> --}}
                    ...
                    @foreach($registros as $registro)
                        @if ($registro->subcategoria_id == 1 && $sub1 == 1)
                            ...
                            <table style="border-collapse: collapse; border-spacing: 0;" class="table table-bordered table-sm table-striped">
                                ...
                                <tbody>
                                    <tr><td colspan="11" class="header-area page_break">PROCESOS</td><tr>
                                    <tr><td colspan="11" class="header-categoria">TRITURACIÓN PRIMARIA Y SECUNDARIA</td></tr>
                        @elseif ($registro->subcategoria_id == 2 && $sub2 == 1)
                            {{ $sub2 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">HPGR</td></tr>
                        @elseif ($registro->subcategoria_id == 3 && $sub3 == 1)
                            {{ $sub3 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">AGLOMERACIÓN</td></tr>
                        @elseif ($registro->subcategoria_id == 4 && $sub4 == 1)
                            {{ $sub4 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">APILAMIENTO - STACKER</td></tr>                        
                        @elseif ($registro->subcategoria_id == 5 && $sub5 == 1)
                            {{ $sub5 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">APILAMIENTO - PRIMARIA Y SECUNDARIA</td></tr>                      
                        @elseif ($registro->subcategoria_id == 6 && $sub6 == 1)
                            {{ $sub6 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">APILAMIENTO - TOTAL APILAMIENTO</td></tr>                     
                        @elseif ($registro->subcategoria_id == 10002 && $sub10002 == 1)
                            ...
                            <table style="border-collapse: collapse; border-spacing: 0;" class="table table-bordered table-sm table-striped">
                                ...
                                <tbody>
                                    <tr><td colspan="11"  class="header-categoria">LIXIVIACIÓN</td></tr>                      
                        @elseif ($registro->subcategoria_id == 10003 && $sub10003 == 1)
                            {{ $sub10003 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">PLANTA SART</td></tr>                   
                        @elseif ($registro->subcategoria_id == 10004 && $sub10004 == 1)
                            {{ $sub10004 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">PLANTA ADR</td></tr>
                        @elseif ($registro->subcategoria_id == 10005 && $sub10005 == 1)
                            {{ $sub10005 = 0 }}
                            <tr><td colspan="11" class="header-area">MINA</td><tr>
                            <tr><td colspan="11" class="header-categoria">MATERIAL MINADO</td></tr>
                        @elseif ($registro->subcategoria_id == 10006 && $sub10006 == 1)
                            {{ $sub10006 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">REMANEJO</td></tr>
                        @elseif ($registro->subcategoria_id == 10007 && $sub10007 == 1)
                            {{ $sub10007 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">MOVIMIENTO TOTAL</td></tr>
                        @elseif ($registro->subcategoria_id == 10008 && $sub10008 == 1)
                            {{ $sub10008 = 0 }}
                            <tr><td colspan="11"  class="header-categoria">DISPONIBILIDAD MECANICA</td></tr>
                        @endif
                        <tr>
                            @php             
