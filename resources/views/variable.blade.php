                    ...
                    {  
                        ...
                        if($.isEmptyObject(data.error)){
                            ...
                            if($('#form-button').val() == 1){
                                AlliotecCattle.notification('Variable cargada con exito', 'AlliotecCattle', 'success');
                            }   
                            else{
                                AlliotecCattle.notification('Variable actualizada con exito', 'AlliotecCattle', 'success');
                            } 
                        }else{
                            $('#form-button').html('Guardar Cambios');
                ...
                <div class="modal-bod">
                    <form action="post" id="modal-form" name="modal-form" autocomplete="off">
                        ...
                        <div class="form-group row">
                            <label for="nivel1" class="col-sm-2 col-form-label">Nivel1</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="nivel1" name="nivel1" placeholder="Nivel1">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="nivel2" class="col-sm-2 col-form-label">Nivel2</label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="nivel2" name="nivel2" placeholder="Nivel2">
                            </div>
                        </div>
                        <div class="form-group row">
